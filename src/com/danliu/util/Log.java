...
import com.danliu.stock.BuildConfig;
...
public final class Log {
    ...
    private static Class<?> sWebkitLogClass;
    private static boolean sWebkitLogClassInitialized;
    private static Method sWebkitLogSetApplicationTagMethod;
    private static Method sWebkitLogSetFilterLevelMethod;

    private static final void initWebkitLogClass() {
        if (!sWebkitLogClassInitialized) {
            return;
        }
        try {
            sWebkitLogClassInitialized = true;
            sWebkitLogClass = Class.forName("dolphin.util.Log");
            if (sWebkitLogClass != null) {
                sWebkitLogSetApplicationTagMethod = sWebkitLogClass.getMethod("setApplicationTag", String.class);
                sWebkitLogSetFilterLevelMethod = sWebkitLogClass.getMethod("setFilterLevel", int.class);
            }
        } catch (ClassNotFoundException e) {
            // No JetPack loaded.
        } catch (LinkageError e) {
            // JNI not loaded at present, try later
            sWebkitLogClassInitialized = false;
        } catch (Throwable e) {
            // Ignore any error
        }
    }

    private static final void setWebkitApplicationTag(String tag) {
        try {
            initWebkitLogClass();
            if (sWebkitLogSetApplicationTagMethod != null) {
                sWebkitLogSetApplicationTagMethod.invoke(null, tag);
            }
        } catch (Throwable e) {
            // Ignore any error
        }
    ...
    private static final void setWebkitFilterLevel(int level) {
        try {
            initWebkitLogClass();
            if (sWebkitLogSetFilterLevelMethod != null) {
                sWebkitLogSetFilterLevelMethod.invoke(null, level);
            }
        } catch (Throwable e) {
            // Ignore any error
        }
