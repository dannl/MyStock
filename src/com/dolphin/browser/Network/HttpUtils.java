...
import com.dolphin.browser.util.StringUtils;
...
//        TraceLog trace = TraceLog.start("Get network content as string");
        ...
        if (entity != null) {
            ...
            result = StringUtils.stringFromInputStream2(inputStream, charset);
        }
...
//        trace.end();
    ...
    public static boolean downloadFile(String url, File saveToFile, long limitLength, boolean keepAlive, String tag) {
    ...
    public static boolean downloadFile(String url, File saveToFile, long limitLength, boolean keepAlive) {
        return downloadFile(url, saveToFile, limitLength, keepAlive, null);
    }
